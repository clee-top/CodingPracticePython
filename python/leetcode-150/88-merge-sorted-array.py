# From https://leetcode.com/problems/merge-sorted-array/description/ You are given two integer arrays nums1 and
# nums2, sorted in non-decreasing order, and two integers m and n, representing the number of elements in nums1 and
# nums2 respectively.
#
...
class Solution:
    def merge(self, nums1: List[int], m: int, nums2: List[int], n: int) -> None:
        ...
        while index_nums2 >= 0:
            # If nums1 is not yet exhausted and the current element is larger than nums2's, place it in the current
            # position
